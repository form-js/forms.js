...
<iframe height="300" style="width: 100%;" scrolling="no" title="forms.js - week example not enhanced" src="https://codepen.io/trilmatic/embed/xxMeabB?default-tab=js%2Cresult" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
  See the Pen <a href="https://codepen.io/trilmatic/pen/xxMeabB">
  forms.js - week example not enhanced</a> by Trilmatic (<a href="https://codepen.io/trilmatic">@trilmatic</a>)
  on <a href="https://codepen.io">CodePen</a>.
</iframe>

### Date formatting

The field accepts <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Date_and_time_formats#week_strings" target="_blank">week strings</a> format `YYYY-WWW`. You can change formatting through flatpickr options.
...
<iframe height="300" style="width: 100%;" scrolling="no" title="forms.js - week example enhanced" src="https://codepen.io/trilmatic/embed/oNmOPWg?default-tab=js%2Cresult" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
  See the Pen <a href="https://codepen.io/trilmatic/pen/oNmOPWg">
  forms.js - week example enhanced</a> by Trilmatic (<a href="https://codepen.io/trilmatic">@trilmatic</a>)
  on <a href="https://codepen.io">CodePen</a>.
</iframe>
