...
-   `default: boolean` - Defines default value.

<iframe height="300" style="width: 100%;" scrolling="no" title="forms.js - color example" src="https://codepen.io/trilmatic/embed/oNmOyqo?default-tab=js%2Cresult" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
  See the Pen <a href="https://codepen.io/trilmatic/pen/oNmOyqo">
  forms.js - color example</a> by Trilmatic (<a href="https://codepen.io/trilmatic">@trilmatic</a>)
