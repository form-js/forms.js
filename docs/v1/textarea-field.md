...
-   `rows: number` - Defines textarea rows.

<iframe height="300" style="width: 100%;" scrolling="no" title="forms.js - textarea example" src="https://codepen.io/trilmatic/embed/MWLRqgV?default-tab=js%2Cresult" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
  See the Pen <a href="https://codepen.io/trilmatic/pen/MWLRqgV">
  forms.js - textarea example</a> by Trilmatic (<a href="https://codepen.io/trilmatic">@trilmatic</a>)
